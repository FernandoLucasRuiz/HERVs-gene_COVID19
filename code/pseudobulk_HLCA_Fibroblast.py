...
file_in = "HLCA_lung_Fibroblast_normal_COVID_filtered.h5ad"
...
pb_df.to_csv("HLCA_Fibroblast_pseudobulk_counts_by_donor.csv.gz")
meta.to_csv("HLCA_Fibroblast_pseudobulk_metadata_by_donor.csv")
